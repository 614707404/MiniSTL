...
namespace davis{
    ...
    private:
        typedef rbtree<key_type, value_type,
                         std::_Identity<value_type>, key_compare, _Alloc> _Rep_type;
    ...
    public:
        ...
        set() : _M_t(_Compare()) {}
        explicit set(const _Compare &__comp) : _M_t(__comp) {}
        template <class _InputIterator>
        set(_InputIterator __first, _InputIterator __last) : _M_t(_Compare())
        {
