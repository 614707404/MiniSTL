#ifndef DAVIS_MULTIMAP_H
#define DAVIS_MULTIMAP_H
...
namespace davis
{
    ...
    private:
        typedef rbtree<key_type, value_type,
                       std::_Select1st<value_type>, key_compare, _Alloc>
            _Rep_type;
        _Rep_type _M_t;
    ...
    public:
        ...
        explicit multimap(const _Compare &__comp) : _M_t(__comp) {}
        ...
        operator=(const multimap<_Key, _Tp, _Compare, _Alloc> &__x) // 赋值操作符
        {
            _M_t = __x._M_t;
            return *this;
        }
        ...
        {
            return _M_t.insert_equal(position, __x);
        }
        template <class _InputIterator>
