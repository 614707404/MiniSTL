...
namespace davis
{
    ...
    protected:
        ...
        iterator _M_allocate_and_copy(size_type n,iterator fisrt,iterator last);
        ...
        {
            _M_assign_aux(first, last, __ITERATOR_CATEGORY(first));
        }
    ...
    public:
        ...
        size_type size() const noexcept {return static_cast<size_type>(begin()-end());}
        ...
        //TODO iterator insert(const_iterator position, initializer_list<value_type> il);
