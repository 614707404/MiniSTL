#ifndef DAVIS_UNORDERED_SET_H
#define DAVIS_UNORDERED_SET_H
...
namespace davis{
    ...
    public:
        ...
        public:
            unordered_set() : _M_ht(100, hasher(), key_equal()) {}
            ...
            template <class _InputIterator>
            unordered_set(_InputIterator __first, _InputIterator __last, size_type __n, const hasher &__hf)
                : _M_ht(__n, __hf, key_equal())
            {
                _M_ht.insert_unique(__first, __last);
            }
            template <class _InputIterator>
            unordered_set(_InputIterator __first, _InputIterator __last, size_type __n, const hasher &__hf, const key_equal &__eql)
                : _M_ht(__n, __hf, __eql)
            {
                _M_ht.insert_unique(__first, __last);
            }
            // copy
            unordered_set(const unordered_set &ust) : _M_ht(ust._M_ht) {}
            ...
            void swap(unordered_set &ust) { _M_ht.swap(ust._M_ht); }
            ...
            {
                std::pair<typename _HT::iterator, bool> __p = _M_ht.insert_unique(__val);
            ...
            friend bool operator==(const unordered_set<Key, Hash, Pred, Alloc> &lhs,
    ...
    template <class Key, class Hash, class Pred, class Alloc>
    void swap(const unordered_set<Key, Hash, Pred, Alloc> &lhs,
                    const unordered_set<Key, Hash, Pred, Alloc> &rhs)
    {
        lhs.swap(rhs);
    }
